...
public class Focas1
{
    ...
    */
    ...
    public class IDBWRR
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] data = new int[MAX_AXIS];
            /* preset data */
    }
...
/*----------------------*/
    ...
    public class PRGDIR
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)] public char[] prg_data; /* directory data */
    } /* In case that the number of data is 256 */
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 31)] public char[] asc; /* ASCII string type */
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 36)] public char[] name; /* running program name */
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string name = new string(' ', 4); /* axis name */
        public int data; /* position data */
        public short dec; /* decimal position */
        public short unit; /* data unit */
    ...
    public class ODBPDFDRV
    {
        ...
        public short dummy;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive1 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive2 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive3 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive4 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive5 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive6 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive7 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive8 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive9 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive10 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive11 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive12 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive13 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive14 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive15 = new string(' ', 12);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string drive16 = new string(' ', 12);
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 212)] public string path = new string(' ', 212); /* path name */
    ...
    public class ODBPDFSDIR
    {
        ...
        public short dummy;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 36)] public string d_f = new string(' ', 36); /* path name */
    }
    ...
    public class ODBPDFADIR
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 36)] public string d_f = new string(' ', 36); /* path name */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 52)] public string comment = new string(' ', 52); /* comment */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string o_time = new string(' ', 12);
...
/*---------------------------*/
    ...
    {
        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] m_ofs = new int[5]; /* M Each */

        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] m_ofs_a = new int[5]; /* M-A All */

        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public short[] t_tip = new short[5]; /* T Each, 2-byte */

        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] t_ofs = new int[5]; /* T Each, 4-byte */
    } /* In case that the number of data is 5 */

    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class OFS_2
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2*5)] public int[] m_ofs_b = new int[10]; /* M-B All */
    } /* In case that the number of data is 5 */

    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class OFS_3
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4*5)] public int[] m_ofs_c = new int[20]; /* M-C All */
    } /* In case that the number of data is 5 */
    ...
    {
        public short tip;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public int[] data;
    } /* T-A All */
    ...
    public class IODBZOR
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7*MAX_AXIS)] public int[] data = new int[7*MAX_AXIS];
            /* offset value */
    ...
    public class IODBMSTP
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)] public sbyte[] data = new sbyte[7];
            /* mesured point value */
    }
    ...
    public class IODBPSD_1
    {
        ...
        [FieldOffset(4)] public byte cdata; /* parameter / setting data */
    ...
    public class IODBPSD_3
    {
        ...
        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas = new byte[MAX_AXIS];

        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas = new short[MAX_AXIS];

        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas = new int[MAX_AXIS];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] prm = new int[10];
    }
    ...
    public class IODBPI
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public sbyte[] data = new sbyte[5]; /* offset value */
    } /* In case that the number of data is 5 */
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data1 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data2 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data3 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data4 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data5 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data6 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data7 = new byte[16];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] data8 = new byte[16];
    }
    ...
    {
        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas1 = new byte[MAX_AXIS];

        [FieldOffset(4*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas2 = new byte[MAX_AXIS];

        [FieldOffset(4*2*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas3 = new byte[MAX_AXIS];

        [FieldOffset(4*3*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas4 = new byte[MAX_AXIS];

        [FieldOffset(4*4*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas5 = new byte[MAX_AXIS];

        [FieldOffset(4*5*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas6 = new byte[MAX_AXIS];

        [FieldOffset(4*6*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas7 = new byte[MAX_AXIS];

        [FieldOffset(4*7*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas8 = new byte[MAX_AXIS];

        [FieldOffset(4*8*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas9 = new byte[MAX_AXIS];

        [FieldOffset(4*9*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas10 = new byte[MAX_AXIS];
    }
    ...
    {
        [FieldOffset(0),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas1 = new short[MAX_AXIS];

        [FieldOffset(2*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas2 = new short[MAX_AXIS];

        [FieldOffset(2*2*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas3 = new short[MAX_AXIS];

        [FieldOffset(2*3*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas4 = new short[MAX_AXIS];

        [FieldOffset(2*4*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas5 = new short[MAX_AXIS];

        [FieldOffset(2*5*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas6 = new short[MAX_AXIS];

        [FieldOffset(2*6*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas7 = new short[MAX_AXIS];

        [FieldOffset(2*7*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas8 = new short[MAX_AXIS];

        [FieldOffset(2*8*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas9 = new short[MAX_AXIS];

        [FieldOffset(2*9*MAX_AXIS),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas10 = new short[MAX_AXIS];
    }

    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class HSPDATA_3
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas1 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas2 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas3 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas4 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas5 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas6 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas7 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas8 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas9 = new int[MAX_AXIS];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas10 = new int[MAX_AXIS];
    }
...
/*----------------------------------------*/
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] dummy; /* dummy */
        public int count; /* tool life counter */
    }
    ...
    public class ODBTLUSE
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] data; /* tool using number */
    ...
    public class IODBTGI2
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] opt_grpno = new int[5];
    ...
    public class IODBTGI3
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] life_rest = new int[5];
...
/*-----------------------------------*/
    ...
    public class IODBTLMNG_data
    {
        ...
        public short gno;
        public short m_ofs;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public int[] reserved = new int[4];
        public int custom1;
        public int custom2;
        public int custom3;
        public int custom4;
    ...
    {
        [FieldOffset(0)] public sbyte data1;
        [FieldOffset(0)] public short data2;
        [FieldOffset(0)] public int data4;
    }
...
/*-------------------------------------*/
    ...
    public class REC_MDI
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public sbyte[] dummy;
    }
    ...
    public class REC_DATE
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public sbyte[] dummy;
    }
    ...
    {
        // record type
        [FieldOffset(0)] public short rec_type; /* record type */

        // alarm record
        [FieldOffset(0)] public short alm_rec_type; /* record type */
        [FieldOffset(2)] public short alm_alm_grp; /* alarm group */
        [FieldOffset(4)] public short alm_alm_no; /* alarm number */
        [FieldOffset(6)] public sbyte alm_axis_no; /* axis number */
        [FieldOffset(7)] public sbyte alm_dummy;

        // mdi record
        [FieldOffset(0)] public short mdi_rec_type; /* record type */
        [FieldOffset(2)] public byte mdi_key_code; /* key code */
        [FieldOffset(3)] public byte mdi_pw_flag; /* power on flag */
        [FieldOffset(4)] public sbyte mdi_dummy1;
        [FieldOffset(5)] public sbyte mdi_dummy2;
        [FieldOffset(6)] public sbyte mdi_dummy3;
        [FieldOffset(7)] public sbyte mdi_dummy4;

        // sign record
        [FieldOffset(0)] public short sgn_rec_type; /* record type */
        [FieldOffset(2)] public sbyte sgn_sig_name; /* signal name */
        [FieldOffset(3)] public byte sgn_sig_old; /* old signal bit pattern */
        [FieldOffset(4)] public byte sgn_sig_new; /* new signal bit pattern */
        [FieldOffset(5)] public sbyte sgn_dummy;
        [FieldOffset(6)] public short sgn_sig_no; /* signal number */

        // date record
        [FieldOffset(0)] public short date_rec_type; /* record type */
        [FieldOffset(2)] public sbyte date_year; /* year */
        [FieldOffset(3)] public sbyte date_month; /* month */
        [FieldOffset(4)] public sbyte date_day; /* day */
        [FieldOffset(5)] public sbyte date_pw_flag; /* power on flag */
        [FieldOffset(6)] public sbyte date_dummy1;
        [FieldOffset(7)] public sbyte date_dummy2;

        // time record
        [FieldOffset(0)] public short time_rec_type; /* record flag */
        [FieldOffset(2)] public sbyte time_hour; /* hour */
        [FieldOffset(3)] public sbyte time_minute; /* minute */
        [FieldOffset(4)] public sbyte time_second; /* second */
        [FieldOffset(5)] public sbyte time_pw_flag; /* power on flag */
        [FieldOffset(6)] public sbyte time_dummy1;
        [FieldOffset(7)] public sbyte time_dummy2;
    }
    ...
    {
        [FieldOffset(0)] public REC_MDI2_data rec_mdi = new REC_MDI2_data();
        [FieldOffset(0)] public REC_SGN2_data rec_sgn = new REC_SGN2_data();
        [FieldOffset(0)] public REC_ALM2_data rec_alm = new REC_ALM2_data();
        [FieldOffset(0)] public REC_DATE2_data rec_date = new REC_DATE2_data();
    }
    ...
    public class REC_IAL4
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] g_modal; /* G code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public char[] g_dp; /* #7:1 Block */
        /* #6Å`#0 dp*/
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] a_modal; /* B,D,E,F,H,M,N,O,S,T code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public char[] a_dp; /* #7:1 Block */
        /* 6Å`#0 dp*/
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public int[] abs_pos; /* Abs pos */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public char[] abs_dp; /* Abs dp  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public int[] mcn_pos; /* Mcn pos */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public char[] mcn_dp; /* Mcn dp  */
    }
    ...
    public class REC_MAL4
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)] public string alm_msg = new string(' ', 64);
            /* alarm message */
    ...
    public class REC_OPM4
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string ope_msg = new string(' ', 256);
            /* Messege */
    }
    ...
    public class ALM_HIS_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string alm_msg = new string(' ', 32);
            /* alarm message */
    }
    ...
    public class ALM_HIS5_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] g_modal; /* G code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public byte[] g_dp; /* #7:1 Block  #6Å`#0 dp */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] a_modal; /* B,D,E,F,H,M,N,O,S,T code Modal */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public byte[] a_dp; /* #7:1 Block  #6Å`#0 dp */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public int[] abs_pos; /* Abs pos */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public byte[] abs_dp; /* Abs dp */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public int[] mcn_pos; /* Mcn pos */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public byte[] mcn_dp; /* Mcn dp */
    }
    ...
    public class ODBOMHIS2_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string alm_msg = new string(' ', 256);
            /* alarm message */
    }
...
/*-------------*/
    ...
    public class ODBSYS
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] cnc_type;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] mt_type;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public char[] series;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public char[] version;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] axes;
    }
    ...
    public class ODBALM
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public short[] dummy = {0, 0};
    ...
    public class ODBMDL_1
    {
        ...
        [FieldOffset(4)] public byte g_data;
    }
    ...
    public class ODBMDL_2
    {
        ...
        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public byte[] g_1shot = new byte[4];

        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 35)] public byte[] g_rdata = new byte[35];
    }
    ...
    public class ODBGCD_data
    {
        public short group;
        public short flag;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 8)] public string code = new string(' ', 8);
    }
    ...
    public class ODBDGN_3
    {
        ...
        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public byte[] cdatas;

        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public short[] idatas;

        [FieldOffset(4),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ldatas;
    }
    ...
    public class OPMSG_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string data = new string(' ', 256);
    ...
    public class OPMSG2_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)] public string data = new string(' ', 64);
            /* operator's message string */
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] slot_no_p;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] slot_no_l;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] mod_id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] soft_id;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series1 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series2 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series3 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series4 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series5 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series6 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series7 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series8 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series9 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series10 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series11 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series12 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series13 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series14 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series15 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_series16 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version1 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version2 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version3 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version4 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version5 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version6 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version7 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version8 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version9 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version10 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version11 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version12 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version13 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version14 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version15 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string s_version16 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] dummy;
        public short m_rom;
        public short s_rom;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public char[] svo_soft;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public char[] pmc_soft;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public char[] lad_soft;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public char[] mcr_soft;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public char[] spl1_soft;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public char[] spl2_soft;
        public short frmmin;
        public short drmmin;
        public short srmmin;
        public short pmcmin;
    ...
    public class ODBPRS
    {
        public short datano; /* dummy */
        public short type; /* dummy */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public short[] data_info; /* data setting information */
        public int rstr_bc; /* block counter */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 35)] public int[] rstr_m; /* M code value */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] rstr_t; /* T code value */
        public int rstr_s; /* S code value */
        public int rstr_b; /* B code value */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] dest; /* program re-start position */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] dist; /* program re-start distance */
    }
    ...
    public class IODBRDNA
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl1_name = new string(' ', 9);
            /* general signal 1 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl2_name = new string(' ', 9);
            /* general signal 2 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl3_name = new string(' ', 9);
            /* general signal 3 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl4_name = new string(' ', 9);
            /* general signal 4 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl5_name = new string(' ', 9);
            /* general signal 5 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl6_name = new string(' ', 9);
            /* general signal 6 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl7_name = new string(' ', 9);
            /* general signal 7 name */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 9)] public string sgnl8_name = new string(' ', 9);
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string sysname = new string(' ', 12);
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string slotname = new string(' ', 12);
            /* Slot Name */
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 12)] public string sramname = new string(' ', 12);
            /* S-RAM data Name */

        public int sramsize; /* S-RAM data Size */
        public short divnumber; /* Division number of S-RAM file */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname1 = new string(' ', 16);
            /* S-RAM data Name1 */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname2 = new string(' ', 16);
            /* S-RAM data Name2 */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname3 = new string(' ', 16);
            /* S-RAM data Name3 */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname4 = new string(' ', 16);
            /* S-RAM data Name4 */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname5 = new string(' ', 16);
            /* S-RAM data Name5 */

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string fname6 = new string(' ', 16);
            /* S-RAM data Name6 */
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string file_name = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)] public string comment = new string(' ', 64);
        public int size;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string date = new string(' ', 16);
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string host_ip = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string host_uname = new string(' ', 32);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string host_passwd = new string(' ', 32);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string host_dir = new string(' ', 128);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 13)] public string dtsv_mac = new string(' ', 13);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string dtsv_ip = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string dtsv_mask = new string(' ', 16);
    }
    ...
    {
        [FieldOffset(0)] public IODBWAVE_io io = new IODBWAVE_io();
        [FieldOffset(0)] public IODBWAVE_axis axis = new IODBWAVE_axis();
    }
    ...
    {
        [FieldOffset(0)] public IODBWVPRM_io io = new IODBWVPRM_io();
        [FieldOffset(0)] public IODBWVPRM_axis axis = new IODBWVPRM_axis();
    }
    ...
    {
        [FieldOffset(0)] public ODBWVDT_io io = new ODBWVDT_io();
        [FieldOffset(0)] public ODBWVDT_axis axis = new ODBWVDT_axis();
    }
    ...
    public class ODBWVDT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8192)] public short[] data;
    }
    ...
    {
        [FieldOffset(0)] public IODBRMTPRM_alm alm = new IODBRMTPRM_alm();
        [FieldOffset(0)] public IODBRMTPRM_io io = new IODBRMTPRM_io();
    }
    ...
    public class ODBRMTDT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1917)] public short[] data;
    }
    ...
    public class ODBMGRP_data
    {
        public int m_code;
        public short grp_no;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 21)] public string m_name = new string(' ', 21);
        public byte dummy;
    }
    ...
    public class IDBMGRP
    {
        ...
        public short dummy;
        public short num;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 500)] public short[] group = new short[500];
    }
    ...
    {
        public int prg_no;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 51)] public string comment = new string(' ', 51);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 13)] public string cuttime = new string(' ', 13);
    }
    ...
    public class PRGDIR3_data
    {
        ...
        public int length;
        public int page;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 52)] public string comment = new string(' ', 52);
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 65)] public string NcApli = new string(' ', 65);
        public byte Dummy1;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 65)] public string HostApli = new string(' ', 65);
        public byte Dummy2;
    ...
    public class IODBINT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8*3)] public int[] data = new int[8*3];
    ...
    public class ODBOMHIS_data
    {
        ...
        public short second; /* second */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string om_msg = new string(' ', 256);
    }
    ...
    public class IODBBTO
    {
        ...
        public short type; /* offset type */
        public short datano_e; /* end offset number */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 18)] public int[] ofs = new int[18]; /* offset */
    ...
    public class ODBSYSS
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] slot_no_p;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] slot_no_l;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] module_id;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] soft_id;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series1 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series2 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series3 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series4 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series5 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series6 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series7 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series8 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series9 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series10 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series11 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series12 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series13 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series14 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series15 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_series16 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version1 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version2 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version3 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version4 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version5 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version6 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version7 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version8 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version9 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version10 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version11 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version12 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version13 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version14 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version15 = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string soft_version16 = new string(' ', 5);
        public short soft_inst;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string boot_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string boot_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string servo_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string servo_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string ladder_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string ladder_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcrlib_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcrlib_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcrapl_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcrapl_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl1_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl1_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl2_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl2_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl3_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl3_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string c_exelib_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string c_exelib_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string c_exeapl_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string c_exeapl_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string int_vga_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string int_vga_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string out_vga_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string out_vga_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmm_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmm_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_mng_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_mng_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_shin_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_shin_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_shout_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_shout_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_c_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_c_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_edit_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string pmc_edit_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string lddr_mng_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string lddr_mng_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string lddr_apl_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string lddr_apl_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl4_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string spl4_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcr2_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcr2_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcr3_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string mcr3_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string eth_boot_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string eth_boot_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8*5)] public byte[] reserve;
    }
    ...
    public class ODBSYSS2
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string eth_boot_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8*5)] public byte[] reserve;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string embEthe_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string embEthe_ver = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 38*5)] public byte[] reserve2;
    }
    ...
    public class ODBSYSS3_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public char[] soft_series;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public char[] soft_edition;
    }
    ...
    public class ODBMDLC
    {
        ...
        public short hi_aio;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)] public short[] reserve;
        public short drmmrc;
        public short drmarc;
        public short pmcmrc;
        public short dmaarc;
        ...
        public short edtpsc;
        public short slcpsc;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 34)] public short[] reserve2;
    }
    ...
    public class IODBPSCD_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public short[] reserve = new short[5];
    }
    ...
    public class IODBPIRC_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public short[] reserve = new short[4];
    }
    ...
    public class IODBSLOP_data
    {
        public int slct;
        public int upleng;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public short[] upsp = new short[10];
        public int dwleng;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public short[] dwsp = new short[10];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public short[] reserve = new short[10];
    }
    ...
    public class IODBLPWDT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public short[] reserve = new short[6];
    }
    ...
    public class ODBLOPDT
    {
        ...
        public int feed_act;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public short[] reserve;
    }
    ...
    public class GASFLOW
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public short[] reserve = new short[3];
    }
    ...
    public class ODBLCMDT
    {
        ...
        public short error;
        public int dsplc;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)] public short[] reserve = new short[7];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 25)] public string comment = new string(' ', 25);
    }
    ...
    public class ODBDISCHRG
    {
        ...
        public short hpa;
        public int hce;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] rfi;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] rfv;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] dci;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] dcv;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] dcw;
    }
    ...
    public class ODBDISCHRGALM_data
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] dcv;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] dcw;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public short[] almcd;
    }
    ...
    public class IODBTIMER
    {
        ...
        [FieldOffset(2)] public short dummy;
        [FieldOffset(4)] public TIMER_DATE date;
        [FieldOffset(4)] public TIMER_TIME time;
    }
    ...
    public class IODBTLCTL
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] total_punch = new int[2];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 11)] public short[] reserve = new short[11];
    }
    ...
    public class IODBTLDT_data
    {
        ...
        public int tl_angle;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public int[] reserve = new int[3];
    }
    ...
    public class IODBMLTTL_data
    {
        ...
        public int tl_size_j;
        public int tl_angle;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)] public int[] reserve = new int[7];
    }
    ...
    public class IODBMTAP_data
    {
        ...
        public int punch_count;
        public int tool_life;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 11)] public int[] reserve = new int[11];
    }
    ...
    public class ODBPTLINF
    {
        ...
        public short reserve;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] tld_size;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] mlt_size;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] public short[] reserves;
    }
    ...
    {
        public short slct;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public int[] data = new int[3];
    }
    ...
    {
        public short slct;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] data = new int[12];
    }
    ...
    {
        public short act_no;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] data;
    }
    ...
    public class ODBBRS
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] dest;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] dist;
    ...
    {
        public short mode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public short[] pln_axes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] ofsvct;
    }
    ...
    {
        public short mode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] ofsvct;
    } /*  In case that the number of axes is MAX_AXIS */
    ...
    public class ODBFIX
    {
        ...
        public int act_cnt;
        public int cut;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] shift;
    }
    ...
    public class ODBROT
    {
        public short mode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public short[] pln_axes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] center;
        public int angle;
    }
    ...
    public class ODB3DCD
    {
        public short mode;
        public short dno;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public short[] cd_axes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2*3)] public int[] center;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2*3)] public int[] direct;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public int[] angle;
    }
    ...
    public class ODBMIR
    {
        public short mode;
        public int mir_flag;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] mir_pos;
    } /*  In case that the number of axes is MAX_AXIS */
    ...
    {
        public short mode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] center;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MAX_AXIS)] public int[] magnif;
    } /*  In case that the number of axes is MAX_AXIS */
    ...
    {
        public short mode;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public short[] ofs_axes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public int[] ofsvct;
    }
    ...
    public class IODBHPPR_tune
    {
        ...
        public int min_cf;
        public int foward;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] reserve = new int[5];
    }
    ...
    public class IODBHPAC_tune
    {
        ...
        public int c_acc;
        public int foward;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public int[] reserve = new int[8];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public short[] axes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] data;
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname1 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname2 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname3 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname4 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname5 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname6 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname7 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname8 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname9 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname10 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname11 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname12 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname13 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname14 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname15 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname16 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname17 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname18 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname19 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname20 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname21 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname22 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname23 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname24 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname25 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname26 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname27 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname28 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname29 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname30 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname31 = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string axname32 = new string(' ', 4);
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string ipaddr = new string(' ', 16);
        public ushort port;
        ...
        public short setno;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public IODBUNSOLIC_pmc[] rddata = new IODBUNSOLIC_pmc[3];
    }
    ...
    {
        public short getno;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public IDBUNSOLICMSG_msg[] msg = new IDBUNSOLICMSG_msg[3];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name1 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name2 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name3 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name4 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name5 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name6 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name7 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name8 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name9 = new string(' ', 62);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name10 = new string(' ', 62);
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 62)] public string name = new string(' ', 62); /* name */
    ...
    public class ODBSYSEX
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)] public short[] reserved = new short[3];
...
/*------------------*/
    ...
    public class IODBIDINF
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 60)] public string id_name = new string(' ', 60);
        public int attr;
        public short unit_len;
        public short unit_max;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)] public byte[] unit = new byte[12];
        public int min_val;
        public int max_val;
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public short[] spndl;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public short[] servo;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 8)] public string axis_name = new string(' ', 8);
    }
...
/*-----*/
    ...
    public class IODBPMC0
    {
        ...
        [FieldOffset(8),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public byte[] cdata; /* PMC data */
    } /* In case that the number of data is 5 */
    ...
    public class IODBPMC1
    {
        ...
        [FieldOffset(8),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public short[] idata;
    } /* In case that the number of data is 5 */
    ...
    public class IODBPMC2
    {
        ...
        [FieldOffset(8),
         MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] public int[] ldata;
    } /* In case that the number of data is 5 */
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string almmsg = new string(' ', 128);
            /* alarm message */
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string mtb = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string machine = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string type = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 8)] public string prgno = new string(' ', 8);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 4)] public string prgvers = new string(' ', 4);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string prgdraw = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string date = new string(' ', 32);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string design = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string written = new string(' ', 48);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 48)] public string remarks = new string(' ', 48);
    }
    ...
    public class IODBPMCEXT
    {
        ...
        [MarshalAs(UnmanagedType.AsAny)] public object data; /* pointer to buffer */
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string master_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 3)] public string master_ver = new string(' ', 3);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string slave_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 3)] public string slave_ver = new string(' ', 3);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 5)] public string cntl_ser = new string(' ', 5);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 3)] public string cntl_ver = new string(' ', 3);
    }
    ...
    public class IODBBUSPRM
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] public byte[] reserve1 = new byte[6];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public byte[] cls2_name = new byte[32];
        public short user_dlen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 62)] public byte[] user_data = new byte[62];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 96)] public byte[] reserve2 = new byte[96];
    }
    ...
    public class IODBSLVPRM
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)] public byte[] reserve1 = new byte[12];
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public byte[] user_pdata = new byte[32];
        public short cnfg_dlen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 126)] public byte[] cnfg_data = new byte[126];
        public short slv_ulen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 30)] public byte[] slv_udata = new byte[30];
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] public byte[] reserve3 = new byte[8];
    }
    ...
    public class IODBSLVPRM2
    {
        ...
        public byte grp_ident;
        public short user_plen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 206)] public byte[] user_pdata = new byte[206];
        public short cnfg_dlen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 126)] public byte[] cnfg_data = new byte[126];
        public short slv_ulen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 30)] public byte[] slv_udata = new byte[30];
    ...
    public class IODBSLVADR
    {
        ...
        public byte do_type;
        public ushort do_addr;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)] public byte[] reserve = new byte[7];
    }
    ...
    public class IODBSLVPRM3
    {
        ...
        public byte slv_flag;
        public byte slv_type;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)] public char[] reserve1 = new char[12];
        public byte slv_stat;
        public byte wd_fact1;
        public byte wd_fact2;
        public byte min_tsdr;
        ...
        public byte grp_ident;
        public short user_plen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 206)] public char[] user_pdata = new char[206];
        public short slv_ulen;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 30)] public char[] slv_udata = new char[30];
    }
    ...
    public class IODBDIDO
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)] public char[] module_data = new char[128];
    }
    ...
    #region DS : Data server & Ethernet board function
    ...
    public class TCPPRM
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string OwnIPAddress = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string SubNetMask = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string RouterIPAddress = new string(' ', 16);
    }
    ...
    public class HOSTPRM
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 16)] public string DataServerIPAddress = new string(' ', 16);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string DataServerUserName = new string(' ', 32);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string DataServerPassword = new string(' ', 32);

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string DataServerLoginDirectory = new string(' ',
            128);
    }
    ...
    public class FTPPRM
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string FTPServerUserName = new string(' ', 32);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string FTPServerPassword = new string(' ', 32);

        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string FTPServerLoginDirectory = new string(' ',
            128);
    }
    ...
    public class ETBPRM
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 13)] public string OwnMACAddress = new string(' ', 128);
    ...
    public class IODBETP
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 210)] public byte[] prm = new byte[210];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 33)] public string title = new string(' ', 33);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 390)] public string message = new string(' ', 390);
    }
    ...
    public class ODBHDDINF
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] public char[] current_dir = new char[32];
    }
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)] public string file_name = new string(' ', 64);
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 80)] public string comment = new string(' ', 80);
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)] public char[] host_file = new char[128];
    }
    ...
    #region HSSB multiple connection
    ...
    public class ODBNODE
    {
        ...
        public int status;
        public int cnc_type;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 20)] public string node_name = new string(' ', 20);
    }
    ...
    #region CNC: Control axis / spindle related
    ...
    public static extern short cnc_rdspmaxrpm(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSPN b);
    ...
    public static extern short cnc_rd5axovrlap(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXIS c);
    ...
    public static extern short cnc_rdexecpt(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] PRGPNT a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] PRGPNT b);

    /* read various axis data */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdaxisdata")]
    public static extern short cnc_rdaxisdata(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        short c, ref short d, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAXDT e);
    ...
    public static extern short cnc_upload(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBUP a,
        ref ushort b);

    /* upload NC program(conditional) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_cupload")]
    public static extern short cnc_cupload(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBUP a,
        ref ushort b);
...
/* read program directory */
    ...
    public static extern short cnc_rdproginfo(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBNC_1 c);

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdproginfo")]
    public static extern short cnc_rdproginfo(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBNC_2 c);
    ...
    public static extern short cnc_rdexecprog(ushort FlibHndl, ref ushort a, out short b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);

    /* read program for MDI operation */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdmdiprog")]
    public static extern short cnc_rdmdiprog(ushort FlibHndl, ref short a,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object b);
...
/* read execution pointer for MDI operation */
    ...
    public static extern short cnc_wrprogline(ushort FlibHndl, int a, uint b,
        [In, MarshalAs(UnmanagedType.AsAny)] Object c, uint d);
    ...
    public static extern short cnc_rdpdf_line(ushort FlibHndl,
        [In, MarshalAs(UnmanagedType.AsAny)] Object a, uint b, [Out, MarshalAs(UnmanagedType.AsAny)] Object c,
        ref uint d, ref uint e);
    ...
    public static extern short cnc_wrpdf_attr(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IDBPDFTDIR b);

    /* copy program file */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_pdf_copy")]
    public static extern short cnc_pdf_copy(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
    ...
    public static extern short cnc_wrpdf_line(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, uint b,
        [In, MarshalAs(UnmanagedType.AsAny)] Object c, uint d);

    /* line edit (delete line by file name) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_pdf_delline")]
    public static extern short cnc_pdf_delline(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, uint b,
        uint c);

    /* move program file */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_pdf_move")]
    public static extern short cnc_pdf_move(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);

    /* read current program and its pointer */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_pdf_rdactpt")]
    public static extern short cnc_pdf_rdactpt(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] Object a,
        out int b);
    ...
    public static extern short cnc_pdf_rename(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);

    /* line edit (search string) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_pdf_searchword")]
    public static extern short cnc_pdf_searchword(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, uint b,
        uint c, uint d, uint e, [In, MarshalAs(UnmanagedType.AsAny)] Object f);
    ...
    public static extern short cnc_pdf_wractpt(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, short b,
        ref int c);

    /* read program drive information */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpdf_inf")]
    public static extern short cnc_rdpdf_inf(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, short b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);
    ...
    public static extern short cnc_rdpdf_subdir(ushort FlibHndl,
        ref short a, [In, MarshalAs(UnmanagedType.LPStruct)] IDBPDFSDIR b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPDFSDIR c);

    /* read directory (all files) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpdf_alldir")]
    public static extern short cnc_rdpdf_alldir(ushort FlibHndl, ref short a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b, [Out, MarshalAs(UnmanagedType.AsAny)] Object c);

    /* read file count in directory */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpdf_subdirn")]
    public static extern short cnc_rdpdf_subdirn(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPDFNFIL b);
    ...
    #region CNC: NC file data related
    ...
    public static extern short cnc_wrtofsr(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTO_1_1 b);

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrtofsr")]
    public static extern short cnc_wrtofsr(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTO_1_2 b);

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrtofsr")]
    public static extern short cnc_wrtofsr(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTO_1_3 b);
    ...
    public static extern short cnc_wrmsptype(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBMSTP d);
...
//      ref short a, short b, ref short c, ref short d, [Out,MarshalAs(UnmanagedType.LPStruct)] IODBPSD_D e );
    ...
    public static extern short cnc_rdparam_ext(ushort FlibHndl,
        [In, Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRMNO a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRM c);
    ...
    public static extern short cnc_start_async_wrparam(ushort FlibHndl,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPRM a);
    ...
    public static extern short cnc_rddiag_ext(ushort FlibHndl,
        [In, Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRMNO a, short b,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPRM c);
    ...
    public static extern short cnc_rdmacro(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBM c);
    ...
    public static extern short cnc_rdmacror2(ushort FlibHndl, int a, ref int b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);

    /* write custom macro variables(IEEE double version) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrmacror2")]
    public static extern short cnc_wrmacror2(ushort FlibHndl, int a, ref int b,
        [In, MarshalAs(UnmanagedType.AsAny)] Object c);
    ...
    public static extern short cnc_wrpmacror(ushort FlibHndl, ushort a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPR b);

    /* read P code macro variables(IEEE double version) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpmacror2")]
    public static extern short cnc_rdpmacror2(ushort FlibHndl, uint a, ref uint b, ushort c,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object d);

    /* write P code macro variables(IEEE double version) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrpmacror2")]
    public static extern short cnc_wrpmacror2(ushort FlibHndl, uint a, ref uint b, ushort c,
        [In, MarshalAs(UnmanagedType.AsAny)] Object d);
    ...
    public static extern short cnc_tofs_rnge(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDATRNG c);

    /* read validity of work zero offset */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_zofs_rnge")]
    public static extern short cnc_zofs_rnge(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDATRNG c);

    /* read validity of work zero offset */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wksft_rnge")]
    public static extern short cnc_wksft_rnge(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBDATRNG b);

    /* read the information for function cnc_rdhsparam() */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdhsprminfo")]
    public static extern short cnc_rdhsprminfo(ushort FlibHndl, int a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] HSPINFO_data b);

    /* read parameters at the high speed */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdhsparam")]
    public static extern short cnc_rdhsparam(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.LPStruct)] HSPINFO b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] HSPDATA_1 c);

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdhsparam")]
    public static extern short cnc_rdhsparam(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.LPStruct)] HSPINFO b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] HSPDATA_2 c);

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdhsparam")]
    public static extern short cnc_rdhsparam(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.LPStruct)] HSPINFO b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] HSPDATA_3 c);
    ...
    #region CNC: Tool life management data related

    /* read tool life management data(tool group number) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdgrpid")]
    public static extern short cnc_rdgrpid(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBTLIFE1 b);
    ...
    public static extern short cnc_rdntool(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBTLIFE3 b);
    ...
    public static extern short cnc_rdcount(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBTLIFE3 b);
    ...
    public static extern short cnc_rdtoolgrp(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBTG c);
    ...
    public static extern short cnc_wrgrpinfo2(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTGI2 b);

    /* write tool life management data(tool group information 3) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrgrpinfo3")]
    public static extern short cnc_wrgrpinfo3(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTGI3 b);
    ...
    #region CNC: Tool management data related
    ...
    public static extern short cnc_wrtool_f2(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTLMNG_F2_data b);

    /* new registration of magazine management data */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_regmagazine")]
    public static extern short cnc_regmagazine(ushort FlibHndl, ref short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTLMAG b);

    /* deletion of magazine management data */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_delmagazine")]
    public static extern short cnc_delmagazine(ushort FlibHndl, ref short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBTLMAG2 b);

    /* lead of magazine management data */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdmagazine")]
    public static extern short cnc_rdmagazine(ushort FlibHndl, ref short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBTLMAG b);
    ...
    #region CNC: Operation history data related
...
//      ref short a, short b, ref short c, ref short d, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBDGN e );
    ...
    public static extern short cnc_adcnv(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBAD c);
    ...
    public static extern short cnc_rdopmsg(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] OPMSG c);

    /* read operator's message */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdopmsg2")]
    public static extern short cnc_rdopmsg2(ushort FlibHndl, short a, short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] OPMSG2 c);
    ...
    public static extern short cnc_getlibopt(ushort FlibHndl, int a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);

    /* set library option */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_setlibopt")]
    public static extern short cnc_setlibopt(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        int c);
    ...
    public static extern short cnc_rdopnlsgnl(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSGNL b);
    ...
    public static extern short cnc_rdopnlgnrl(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBGNRL b);
    ...
    public static extern short cnc_rdopnlgsname(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBRDNA b);
    ...
    public static extern short cnc_getfigure(ushort FlibHndl,
        short a, out short b, [Out, MarshalAs(UnmanagedType.AsAny)] Object c,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object d);

    /* read F-ROM information on CNC  */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdfrominfo")]
    public static extern short cnc_rdfrominfo(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBFINFO b);

    /* start of reading F-ROM data from CNC */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_fromsvstart")]
    public static extern short cnc_fromsvstart(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        int c);

    /* read F-ROM data from CNC */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_fromsave")]
    public static extern short cnc_fromsave(ushort FlibHndl, out short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);
    ...
    public static extern short cnc_fromdelete(ushort FlibHndl, short a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        int c);
    ...
    public static extern short cnc_srambackup(ushort FlibHndl, out short a,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object b, ref int c);
    ...
    public static extern short cnc_fromget(ushort FlibHndl, out short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);
    ...
    public static extern short cnc_sramget(ushort FlibHndl, out short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);

    /* read S-RAM data from CNC (2) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_sramget2")]
    public static extern short cnc_sramget2(ushort FlibHndl, out short a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);
    ...
    public static extern short cnc_rdsramaddr(ushort FlibHndl, out short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] SRAMADDR b);
    ...
    public static extern short cnc_dtsvrdcram(ushort FlibHndl, int a, ref int b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);
    ...
    public static extern short cnc_rdrmtwaveprm(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBRMTPRM a,
        short b);
    ...
    public static extern short cnc_rdsavsigadr(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSIGAD a,
        short b);

    /* write of address for PMC signal batch save */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrsavsigadr")]
    public static extern short cnc_wrsavsigadr(ushort FlibHndl, [In, MarshalAs(UnmanagedType.LPStruct)] IODBSIGAD a,
        out short b);
    ...
    public static extern short cnc_wrwkcdshft(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBWCSF b);
    ...
    public static extern short cnc_wrwkcdsfms(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBWCSF b);
    ...
    public static extern short cnc_wrmngtime(ushort FlibHndl, int a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBMNGTIME b);
    ...
    public static extern short cnc_rdactfixofs(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBZOFS b);
    ...
    public static extern short cnc_rdcexesram(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);

    /* write SRAM variable area for C language executor */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrcexesram")]
    public static extern short cnc_wrcexesram(ushort FlibHndl, int a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        ref int c);
    ...
    public static extern short cnc_wrunsolicprm(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBUNSOLIC b);

    /* Get the unsolicited message parameters */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdunsolicprm")]
    public static extern short cnc_rdunsolicprm(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBUNSOLIC b);
    ...
    public static extern short cnc_rdpm_mcnitem(ushort FlibHndl, short a, ref short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBITEM c);

    /* write machine specific maintenance item */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrpm_mcnitem")]
    public static extern short cnc_wrpm_mcnitem(ushort FlibHndl, short a, short b,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBITEM c);

    /* read cnc maintenance item */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpm_cncitem")]
    public static extern short cnc_rdpm_cncitem(ushort FlibHndl, short a, ref short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBITEM c);

    /* read maintenance item status */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdpm_item")]
    public static extern short cnc_rdpm_item(ushort FlibHndl, short a, ref short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPMAINTE c);

    /* write maintenance item status */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_wrpm_item")]
    public static extern short cnc_wrpm_item(ushort FlibHndl, short a, short b, short c,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMAINTE d);
    ...
    public static extern short cnc_rdsyshard(ushort FlibHndl, short a, ref short b,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSYSH c);

    /* read CNC system soft series and version (3) */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdsyssoft3")]
    public static extern short cnc_rdsyssoft3(ushort FlibHndl, short a, ref short b, out short c,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSYSS3 d);
    ...
    public static extern short cnc_srcsrdopdata(ushort FlibHndl, int a, ref int b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);

    /* Write operation data to data buffer for SERCOS I/F */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_srcswropdata")]
    public static extern short cnc_srcswropdata(ushort FlibHndl, int a, int b,
        [In, MarshalAs(UnmanagedType.AsAny)] Object c);
    ...
    #region CNC : Graphic command data
    ...
    public static extern short cnc_rdgrphcmd(ushort FlibHndl, ref short a,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object b);
    ...
    #region CNC : Servo learning data
    ...
    public static extern short cnc_sdstartsmpl(ushort FlibHndl, short a, int b,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object c);
    ...
    #region CNC : NC display function
    ...
    #region CNC : Remote diagnostics function
    ...
    #region CNC: Teaching data I/F function
    ...
    #region CNC : C-EXE SRAM file function

    /* open C-EXE SRAM file */

    [DllImport("FWLIB32.dll", EntryPoint = "cnc_opencexefile")]
    public static extern short cnc_opencexefile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, short b,
        short c);
    ...
    public static extern short cnc_rdcexefile(ushort FlibHndl, [Out, MarshalAs(UnmanagedType.AsAny)] Object a,
        ref uint b);
    ...
    public static extern short cnc_cexedirectory(ushort FlibHndl,
        [In, MarshalAs(UnmanagedType.AsAny)] Object a, ref ushort b, ushort c,
        [Out, MarshalAs(UnmanagedType.LPStruct)] CFILEINFO d);
    ...
    public static extern short pmc_wrpmcrng(ushort FlibHndl, ushort a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMC0 b);

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_wrpmcrng")]
    public static extern short pmc_wrpmcrng(ushort FlibHndl, ushort a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMC1 b);

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_wrpmcrng")]
    public static extern short pmc_wrpmcrng(ushort FlibHndl, ushort a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMC2 b);

    /* read data from extended backup memory */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdkpm")]
    public static extern short pmc_rdkpm(ushort FlibHndl, uint a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        ushort c);

    /* write data to extended backup memory */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_wrkpm")]
    public static extern short pmc_wrkpm(ushort FlibHndl, uint a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        ushort c);

    /* read data from extended backup memory 2 */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdkpm2")]
    public static extern short pmc_rdkpm2(ushort FlibHndl, uint a, [Out, MarshalAs(UnmanagedType.AsAny)] Object b,
        uint c);
    ...
    public static extern short pmc_rdpmcinfo(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBPMCINF b);
    ...
    public static extern short pmc_wrcntldata(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMCCNTL b);
    ...
    public static extern short pmc_wriolinkdat(ushort FlibHndl, uint a, [In, MarshalAs(UnmanagedType.AsAny)] Object b,
        uint c);
    ...
    public static extern short pmc_prfrdslvprm(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM b);

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfrdslvprm")]
    public static extern short pmc_prfrdslvprm(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM2 b);

    /* write slave parameter for master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrslvprm")]
    public static extern short pmc_prfwrslvprm(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM b);

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrslvprm")]
    public static extern short pmc_prfwrslvprm(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM2 b);

    /* read allocation address for master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfrdallcadr")]
    public static extern short pmc_prfrdallcadr(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPRFADR b);

    /* set allocation address for master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrallcadr")]
    public static extern short pmc_prfwrallcadr(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBPRFADR b);
    ...
    public static extern short pmc_prfrdslvid(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSLVID b);

    /* Writes slave index data of master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrslvid")]
    public static extern short pmc_prfwrslvid(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBSLVID b);

    /* Reads slave parameter of master function(2) */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfrdslvprm2")]
    public static extern short pmc_prfrdslvprm2(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM3 b);

    /* Writes slave parameter of master function(2) */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrslvprm2")]
    public static extern short pmc_prfwrslvprm2(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBSLVPRM3 b);

    /* Reads DI/DO parameter of master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfrddido")]
    public static extern short pmc_prfrddido(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] IODBDIDO b);

    /* Writes DI/DO parameter of master function */

    [DllImport("FWLIB32.dll", EntryPoint = "pmc_prfwrdido")]
    public static extern short pmc_prfwrdido(ushort FlibHndl, short a,
        [In, MarshalAs(UnmanagedType.LPStruct)] IODBDIDO b);
    ...
    public static extern short etb_rderrmsg(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBETMSG b);
    ...
    public static extern short ds_rdhdddir(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a, int b,
        out short c, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBHDDDIR d);
    ...
    public static extern short ds_copyhddfile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);

    /* change the file name of the Data Server's HDD */

    [DllImport("FWLIB32.dll", EntryPoint = "ds_renhddfile")]
    public static extern short ds_renhddfile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);

    /* execute the PUT command of the FTP */

    [DllImport("FWLIB32.dll", EntryPoint = "ds_puthddfile")]
    public static extern short ds_puthddfile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);
    ...
    public static extern short ds_rdhostdir(ushort FlibHndl, short a, int b, out short c,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBHOSTDIR d, int e);

    /* read the file list of the host 2 */

    [DllImport("FWLIB32.dll", EntryPoint = "ds_rdhostdir2")]
    public static extern short ds_rdhostdir2(ushort FlibHndl, short a, int b, out short c, out int d,
        [Out, MarshalAs(UnmanagedType.LPStruct)] ODBHOSTDIR e, int f);
    ...
    public static extern short ds_gethostfile(ushort FlibHndl, [In, MarshalAs(UnmanagedType.AsAny)] Object a,
        [In, MarshalAs(UnmanagedType.AsAny)] Object b);
    ...
    public static extern short ds_rddnchostfile(ushort FlibHndl, out short a,
        [Out, MarshalAs(UnmanagedType.AsAny)] Object b);
    ...
    public static extern short ds_rdmntinfo(ushort FlibHndl, short a,
        [Out, MarshalAs(UnmanagedType.LPStruct)] DSMNTINFO b);
