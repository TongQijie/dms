...
CREATE TABLE DeviceSparePartDeviceInfoMapping
(
  Id	INT	IDENTITY(1, 1),
  SparePartNumber VARCHAR(20) NOT NULL,
  DeviceNumber VARCHAR(20) NOT NULL,
  CONSTRAINT PK_DEVICESPAREPARTDEVICEINFOMAPPING PRIMARY KEY (Id),
);

CREATE INDEX IX_DEVICESPAREPARTDEVICEINFOMAPPING_DEVICENUMBER ON DeviceSparePartDeviceInfoMapping (DeviceNumber);
